      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24 lg:py-32">
        <div className="text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
            Transform Careers with Industry Focused Training Programs
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl mb-10 text-primary-100 max-w-4xl mx-auto leading-relaxed">
            Industry focused training programs for hospitals, schools, colleges, and corporate organizations.
          </p>
          ...
          <p className="mt-4 text-sm text-indigo-100">
            Trusted training programs for hospitals, colleges, and industry professionals.
          </p>
