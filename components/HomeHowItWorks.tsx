      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6 mb-10">
            <div className="flex-shrink-0 w-16 h-16 rounded-full bg-primary-600 text-white flex items-center justify-center text-2xl font-bold shadow-lg">
              1
            </div>
          ...
          <div className="flex justify-center md:justify-start md:ml-8 mb-6">
            <ArrowRight className="w-8 h-8 text-primary-400 rotate-90 md:rotate-0" aria-hidden />
          </div>

          {/* Step 2 - branch */}
          <div className="flex flex-col md:flex-row md:items-stretch gap-6">
            <div className="flex-shrink-0 w-16 h-16 rounded-full bg-primary-600 text-white flex items-center justify-center text-2xl font-bold shadow-lg md:self-start">
              2
            </div>
