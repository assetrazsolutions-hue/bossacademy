      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-light max-w-2xl mx-auto">
            Get in touch with us for inquiries about our training programs, partnerships, or any questions you may have.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:9916800685" className="text-primary-600 hover:text-primary-700 text-lg">
                      9916800685
                    </a>
                  </div>
                </div>
          ...
          <div>
            <div className="bg-background-light rounded-xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" className="btn-cta w-full px-6 py-3">
                  Send Message
                </button>
              </form>
            </div>
